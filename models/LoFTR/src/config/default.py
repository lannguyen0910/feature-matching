...
# training tricks: save GPU memory
_CN.LOFTR.MATCH_COARSE.TRAIN_COARSE_PERCENT = 0.2
# training tricks: avoid DDP deadlock
...
_CN.DATASET.TRAINVAL_DATA_SOURCE = None  # options: ['IMCDataset']
...
# 2. dataset config
# general options
# discard data with overlap_score < min_overlap_score
_CN.DATASET.MIN_OVERLAP_SCORE_TRAIN = 0.4
_CN.DATASET.MIN_OVERLAP_SCORE_TEST = 0.0
_CN.DATASET.AUGMENTATION_TYPE = None  # options: [None, 'dark', 'mobile']

# MegaDepth options
# resize the longer side, zero-pad bottom-right to square.
...
# number of val/test paris for plotting
...
# options: ['scene_balance', 'random', 'normal']
